            ...
            <div class="card-body">
              <div class="media">
                ...
                <b-dropdown right toggle-class="text-body p-0" variant="black">
                  ...
                  <b-dropdown-item>مشاهده سفارشات</b-dropdown-item>
                  <b-dropdown-item>پوشش بیمه ها</b-dropdown-item>
                  <b-dropdown-item>قیمت گزاری</b-dropdown-item>
                  <b-dropdown-item>غیر فعال کردن</b-dropdown-item>
                </b-dropdown>
              </div>
              ...
              <div class="text-muted">
                <div class="row">
                  <div class="col-6">
                    <div>
                      <p class="text-truncate mb-0">درآمد کل</p>
                      <h5 class="mb-sm-0">{{ companiesdata.revenue }}</h5>
                    </div>
                  </div>
                  <div class="col-6">
                    <div>
                      <p class="text-truncate mb-0">میزان رضایتمندی</p>
