...
const scatterChart = {
    chartOptions: {
        ...
        colors: ['#f7b84b', '#f1556c', '#6c757d', '#4fc6e1', '#6559cc'],
        grid: {
            borderColor: '#f1f3fa',
            xaxis: {
                showLines: true
...
const gradientDonutChart = {
    ...
    chartOptions: {
        ...
        labels: ['Series 1', 'Series 2', 'Series 3', 'Series 4', 'Series 5'],
        colors: ['#08BCC0', '#26c6da', '#80deea', '#00b19d', '#d1dee4'],
        responsive: [{
            breakpoint: 600,
            options: {
                chart: {
